...
See, that was quick wasn't it? Now, you are ready to do some really fun stuff with Docker. Go on to the next part [to locate and run the whalesay image](/linux/step_three).
